...
def create_env(env_path, worker_id=0, time_scale=2.0, no_graphics=False):
    ...
    unity_env = UnityEnvironment(env_path, side_channels=[channel], worker_id=22, no_graphics=no_graphics, base_port=5)
...
class RewardLoggingCallback(BaseCallback):
    def __init__(self, log_interval, base_path, model_name, verbose=0):
        ...
        # Generate the log file path with versioning
...
if __name__ == '__main__':
    ...
    env = r"continuous_path_build\3DPos.exe"
    ...
    model = SAC("MlpPolicy", env_scene1, verbose=2, tensorboard_log=tensorboard_log_path_scene1,
