...
def main():
    filenames = [
        r'continuous_models\logs_models\TD3_31082024_v0\TD3_reward_log.txt',
        r'continuous_models\logs_models\sac_31082024_v1\sac_reward_log.txt',
        r'continuous_models\logs_models\ppo_31082024_v0\ppo_reward_log.txt'
    ]
