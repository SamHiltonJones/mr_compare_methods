...
def create_env(env_path, worker_id=0, time_scale=2.0, no_graphics=False):
    ...
    unity_env = UnityEnvironment(env_path, side_channels=[channel], worker_id=22, no_graphics=no_graphics, base_port=2)
...
if __name__ == '__main__':
    ...
    env = r"continuous_build\3DPos.exe"
    ...
    base_path = 'continuous_models/logs_models'
    trained_models_path = 'continuous_models/trained_models'
    ...
    model = TD3("MlpPolicy", env_scene1, verbose=2, tensorboard_log=tensorboard_log_path_scene1,
